...
Gateway allows you to send copies of entire HTTP requests matched in DLP policies to storage destinations configured in [Logpush](/logs/about/). With the Logpush integration, you can capture, store, and view DLP matches for forensic investigation.
